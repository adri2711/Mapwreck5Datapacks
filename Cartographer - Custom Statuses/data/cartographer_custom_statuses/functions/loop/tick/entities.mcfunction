...
execute if score @s ca.effect_bleed matches 1.. unless score $realms suso_var matches 1 run function cartographer_custom_statuses:tick_effects/bleeding
execute if score @s ca.effect_bleed matches 1.. if score $realms suso_var matches 1 run function cartographer_custom_statuses:tick_effects/bleeding_censored
