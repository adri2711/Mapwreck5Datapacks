...
execute if score @s co_motion_animation matches 35..50 at @s if score @s co_flank_dir matches 0 run scoreboard players set @s co_yaw 6
execute if score @s co_motion_animation matches 35..50 at @s if score @s co_flank_dir matches 1 run scoreboard players set @s co_yaw -6
