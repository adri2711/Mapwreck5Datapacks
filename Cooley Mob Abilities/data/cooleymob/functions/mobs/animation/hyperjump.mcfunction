...
execute if score @s co_motion_animation matches 40 at @s run scoreboard players set @s co_y 7
execute if score @s co_motion_animation matches 40 at @s run scoreboard players set @s co_send 33 
