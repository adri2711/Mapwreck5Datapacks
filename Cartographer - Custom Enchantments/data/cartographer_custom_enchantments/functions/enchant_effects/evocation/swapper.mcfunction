...
execute unless score $realms suso_var matches 1 if entity @s[scores={ca.bleeding=1..}] run particle minecraft:block redstone_block ~ ~0.2 ~ 0.25 0 0.25 0 10 normal
execute unless score $realms suso_var matches 1 if entity @s[scores={ca.bleeding=1..}] run particle minecraft:block redstone_block ~ ~0.6 ~ 0.1 0.5 0.1 0 15 normal
execute if score $realms suso_var matches 1 if entity @s[scores={ca.bleeding=1..}] run particle minecraft:block crying_obsidian ~ ~0.2 ~ 0.25 0 0.25 0 10 normal
execute if score $realms suso_var matches 1 if entity @s[scores={ca.bleeding=1..}] run particle minecraft:block crying_obsidian ~ ~0.6 ~ 0.1 0.5 0.1 0 15 normal
