...
execute unless score $realms suso_var matches 1 if score $eruption ca.bleeding matches 1.. run particle minecraft:block minecraft:redstone_block ~ ~1 ~ 0.25 0.4 0.25 0 10 normal
execute if score $realms suso_var matches 1 if score $eruption ca.bleeding matches 1.. run particle minecraft:block minecraft:crying_obsidian ~ ~1 ~ 0.25 0.4 0.25 0 10 normal
