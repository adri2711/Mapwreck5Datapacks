...
execute unless score $realms suso_var matches 1 if score $eruption ca.bleeding matches 1.. run function cartographer_custom_enchantments:enchant_effects/eruption/particle_bleed
execute if score $realms suso_var matches 1 if score $eruption ca.bleeding matches 1.. run function cartographer_custom_enchantments:enchant_effects/eruption/particle_bleed_censored
