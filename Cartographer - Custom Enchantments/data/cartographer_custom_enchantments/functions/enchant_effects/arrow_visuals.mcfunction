execute unless score $realms suso_var matches 1 if entity @s[scores={ca.bleed=1..}] run particle minecraft:block redstone_block ~ ~ ~ 0.2 0.2 0.2 0.1 1 normal
execute if score $realms suso_var matches 1 if entity @s[scores={ca.bleed=1..}] run particle minecraft:block crying_obsidian ~ ~ ~ 0.2 0.2 0.2 0.1 1 normal
