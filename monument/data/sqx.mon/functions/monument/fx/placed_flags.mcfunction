# Beam
execute unless score $obj1_placed sqx.var matches 1 if block ~ ~ ~ white_wool run particle
execute unless score $obj2_placed sqx.var matches 1 if block ~ ~ ~ orange_wool run particle
execute unless score $obj3_placed sqx.var matches 1 if block ~ ~ ~ magenta_wool run particle
execute unless score $obj4_placed sqx.var matches 1 if block ~ ~ ~ light_blue_wool run particle
execute unless score $obj5_placed sqx.var matches 1 if block ~ ~ ~ yellow_wool run particle
execute unless score $obj6_placed sqx.var matches 1 if block ~ ~ ~ lime_wool run particle
execute unless score $obj7_placed sqx.var matches 1 if block ~ ~ ~ pink_wool run particle
execute unless score $obj8_placed sqx.var matches 1 if block ~ ~ ~ purple_wool run particle
execute unless score $obj9_placed sqx.var matches 1 if block ~ ~ ~ blue_wool run particle
execute unless score $obj10_placed sqx.var matches 1 if block ~ ~ ~ green_wool run particle
execute unless score $obj11_placed sqx.var matches 1 if block ~ ~ ~ red_wool run particle
execute unless score $obj12_placed sqx.var matches 1 if block ~ ~ ~ black_wool run particle
