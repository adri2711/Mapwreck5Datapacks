...
execute unless score $obj2_placed sqx.var matches 1 if block ~ ~ ~ prange_wool run scoreboard players set $obj2_placed sqx.var 1
...
execute unless score $obj7_placed sqx.var matches 1 if block ~ ~ ~ pink_wool run scoreboard players set $obj8_placed sqx.var 1
execute unless score $obj8_placed sqx.var matches 1 if block ~ ~ ~ purple_wool run scoreboard players set bj7_placed sqx.var 1
execute unless score $obj9_placed sqx.var matches 1 if block ~ ~ ~ blue_wool run scoreboard players set $o$obj9_placed sqx.var 1
