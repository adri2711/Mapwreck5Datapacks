...
execute unless score $bonus_obj1_placed mon.count matches 1 if block ~ ~ ~ barrier run scoreboard players set $bonus_obj1_placed mon.count 1
execute unless score $bonus_obj2_placed mon.count matches 1 if block ~ ~ ~ barrier run scoreboard players set $bonus_obj2_placed mon.count 1
execute unless score $bonus_obj3_placed mon.count matches 1 if block ~ ~ ~ barrier run scoreboard players set $bonus_obj3_placed mon.count 1
