...
execute positioned ~ ~ ~ if entity @s[distance=...8] run scoreboard players set @s tp.track 7
execute positioned -5 54 -42 if entity @s[distance=...8] run scoreboard players set @s tp.track 8
execute positioned ~ ~ ~ if entity @s[distance=...8] run scoreboard players set @s tp.track 9
execute positioned ~ ~ ~ if entity @s[distance=...8] run scoreboard players set @s tp.track 10
