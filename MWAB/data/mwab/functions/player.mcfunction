...
execute if score @s mwab.timer.blastboots matches 30 at @s run function mwab:abilities/items/blastboots/ability_prime
execute if score @s mwab.timer.blastboots matches 30..59 if score @s mwab.Shift matches 0 run function mwab:abilities/items/blastboots/boost
